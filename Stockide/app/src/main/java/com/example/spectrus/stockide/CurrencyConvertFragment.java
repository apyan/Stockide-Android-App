...
public class CurrencyConvertFragment extends Fragment implements View.OnClickListener {
    ...
    AppGraphics currencyFragGraphics;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Set fragment
        View v = inflater.inflate(R.layout.fragment_currency_convert, container, false);
        currencyFragGraphics = new AppGraphics(getActivity());
